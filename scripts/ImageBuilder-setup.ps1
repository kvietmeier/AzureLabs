...
$imageName="Win10MS-2004-custom01"

# image distribution metadata reference name
$runOutputName="Win10MS2004custom01"

# image template name
$imageTemplateName="Win10MS2004Template01"

# distribution properties object name (runOutput), i.e. this gives you the properties of the managed image on completion
$runOutputName="Win10MS2004SigR01"
...
# As there are currently no specific Azure PowerShell cmdlets for image builder,
# we need to construct API calls, with the authentication, this is just an 
# example, note, you can use existing alternatives you may have.
...
# The image build for this example will take approximately 50mins (multiple reboots,
# windows update installs/reboot), when you query the status, you need to look for 
# lastRunStatus, below shows the build is still running, if it had completed 
# successfully, it would show 'suceeded'.

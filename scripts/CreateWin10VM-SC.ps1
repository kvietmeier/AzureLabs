...
# VM Name, Size, and Image in my Shared Image Gallery
$NewVMConfig = New-AzVMConfig -VMName $VMName -VMSize $VMSize | Set-AzVMSourceImage -Id $ImageDefinition.Id
...
$vNetName  = "WVDSouthCentral-vnet01"
$vNetRG    = "WVDLandscape-SCentral"
$NsgName   = "AllowRDP"
...
<# # Source Image (using Azure Image Gallery)

...
<# 
https://docs.microsoft.com/en-us/powershell/module/az.network/set-aznetworksecuritygroup?view=azps-6.4.0
...
https://docs.microsoft.com/en-us/powershell/module/az.network/set-aznetworksecurityruleconfig?view=azps-6.4.0
...
Get-AzNetworkSecurityGroup -Name "RestrictByIP"

# Complicated Examples
Get-AzNetworkSecurityGroup -Name "Nsg1" `
    -ResourceGroupName "Rg1" | Add-AzNetworkSecurityRuleConfig `
    -Name "Rdp-Rule" `
...
Set-AzNetworkSecurityRuleConfig -Access Allow `
    -Name 'rdp-rule' `
    -NetworkSecurityGroup "<PSNetworkSecurityGroup>" `
    -DestinationAddressPrefix * `
...
# Get your public IP:
# https://www.sean-lloyd.com/post/get-public-ip-using-powershell/
#$MyIP = Invoke-WebRequest -uri "https://ident.me/"
#$MyIp.Content
$MyIP = Invoke-RestMethod -uri "https://ipinfo.io"
$MyIP.ip
...
# Port Range can only be an integer, a range, or all "*"
# You need all of the settings for the command to work
$NSGSettings = (Set-AzNetworkSecurityRuleConfig -Access Allow `
    -Name $RuleName `
...
# Apply the settings
$NSGSsettings = ($NSG | Set-AzNetworkSecurityGroup)

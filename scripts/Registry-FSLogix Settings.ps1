...
# $FSLUNC = "\\server\share"  
$FSLUNC = "\\kvwvdlocalstorage01.file.core.windows.net\userprofiles\"
...
# We need to crrate the "Profiles" folder first
...
Set-ItemProperty -Path HKLM:\Software\FSLogix\Profiles `
    -Name "SizeInMBs" -Type "Dword" -Value "10240"  
...
Set-ItemProperty -Path HKLM:\Software\FSLogix\Profiles `
    -Name "DeleteLocalProfileWhenVHDShouldApply"  -Type "Dword" -Value "0"
...
Set-ItemProperty -Path HKLM:\SOFTWARE\Policies\FSLogix\ODFC -Name "SizeInMBs" -Type "Dword" -Value "25600"
# This shoudl be set to "vhd" for Win 7 and Sever 2102R2
Set-ItemProperty -Path HKLM:\SOFTWARE\Policies\FSLogix\ODFC -Name "VolumeType" -Type String -Value "vhdx"
...
Set-ItemProperty -Path HKLM:\SOFTWARE\Policies\FSLogix\ODFC -Name "DeleteLocalProfileWhenVHDShouldApply"  -Type "Dword" -Value "0"